 ...
 * 
 * Note: Clustering algorithm uses a tf weighting mechanism instead of tf-idf.
 * Check ClusteringWithTfIdf.java for tf-idf weighting mechanism
 * 
 * Uncomment all System.logs to understand more about this code.
 * ClusteringWithTfIdf.java contains uncommented System.logs. 
 * The two files are really similar, only using different mechanisms.
 * 
...
public class Clustering {
	 ...
	 */
	public void clusterWithKmeans(){
		if (k < 2) {
			// Can't cluster
			System.out.println("Can't cluster. Please supply k = 2 or greater.");
			return;
		} else {
